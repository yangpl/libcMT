/* Core utility implementation shared across the codebase.
 * Contains generic memory-allocation helpers, parameter parsing, and
 * error/reporting routines used by the MT modelling and inversion code.
 */
...
{
  return (float _Complex*****)alloc5(n1,n2,n3,n4,n5,sizeof(float _Complex));
}
