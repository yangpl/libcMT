...
\end{equation}
We take the logarithmic conductivity as the model parameter, $m:=\ln \sigma$. The chain rule then gives $\frac{\partial \Phi_d}{\partial m}=\sigma \frac{\partial \Phi_d}{\partial \sigma}$.
...
\begin{equation}
 ...
 -\overline{W_{xy}\Delta Z_{xy}}W_{xy}\frac{\partial Z_{xy}}{\partial u^p}
  ...
  \end{aligned}
\end{equation}
where $W_{xx}$, $W_{xy}$, $W_{yx}$, and $W_{yy}$ denote the diagonal entries of the data-weighting matrix $W_d$ defined above from the assigned impedance errors. 
