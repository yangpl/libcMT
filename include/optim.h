/* Public interface for inversion optimization routines.
 * Defines optimizer modes, status codes, the optimizer state structure,
 * and the helper APIs used by the inversion driver.
 */
#ifndef OPTIM_H
#define OPTIM_H
