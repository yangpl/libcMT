/* Shared low-level utilities and declarations.
 * Collects common system headers, numeric macros, allocation helpers,
 * parameter-parsing interfaces, and error-reporting declarations.
 */
#ifndef cstd_h
#define cstd_h
...
float _Complex *****alloc5complexf(size_t n1, size_t n2, size_t n3, size_t n4, size_t n5);
...
void free5complexf(float _Complex *****p);
...
double _Complex *****alloc5complex(size_t n1, size_t n2, size_t n3, size_t n4, size_t n5);
...
void free5complex(double _Complex *****p);
